describe("TheMask Component", () => {
  ...
  describe("Basic Masking", () => {
    it("Should apply US zip mask correctly", () => {
      cy.get("#us-zip").clear().type("54321").should("have.value", "54321");
    });
    ...
    it("should apply time mask correctly", () => {
      cy.get("#time").clear().type("121212").should("have.value", "12:12:12");
    });
    ...
    it("should apply Canada zip mask correctly", () => {
      cy.get("#ca-zip").clear().type("A1B2C3").should("have.value", "A1B 2C3");
    });
  ...
  describe("Dynamic Masks", () => {
    ...
    it("should apply Bank Agency 3th digit mask correctly", () => {
      cy.get("#bank-agency").clear().type("123").should("have.value", "123");
    });

    it("should apply Bank Agency 4th digit mask correctly", () => {
      cy.get("#bank-agency").clear().type("1231").should("have.value", "123-1");
    });
  ...
  describe("Edge Cases", () => {
    it("should handle mask at end correctly", () => {
      cy.get("#maskAtEnd").type("12").should("have.value", "(12)");
    });
